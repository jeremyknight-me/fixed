...
{
    [Fact]
    public void Generation_Should_Read_Fixed_Text()
    {
        List<string> lines = ["FalseAB2024-03-201234 4.30"];
        IEnumerable<SampleObject> items = SampleObjectFixedSerializer.Deserialize(lines);
    ...
    [Fact]
    public void Generation_Should_Write_Fixed_Text()
    {
        ...
        IEnumerable<string> lines = SampleObjectFixedSerializer.Serialize(items);
